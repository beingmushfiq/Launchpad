    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--text-secondary)] mt-1">Sign in to your Launchpad account</p>
        </div>
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg)] p-6 sm:p-8 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-[var(--border)] text-primary-600" />
                <span className="text-sm text-[var(--text-secondary)]">Remember me</span>
              </label>
              <Link to="/auth/forgot-password" className="text-sm font-medium text-primary-600 hover:text-primary-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center"><span className="px-3 bg-[var(--bg)] text-xs text-[var(--text-tertiary)]">or continue with</span></div>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-[var(--text-secondary)]">
          ...
          <Link to="/auth/register" className="font-medium text-primary-600 hover:text-primary-700">Create one</Link>
        </p>
      </motion.div>
    </div>
  );
